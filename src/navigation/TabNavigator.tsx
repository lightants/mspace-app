...
export default function TabNavigator() {
  ...
  return <Tab.Navigator initialRouteName="Book" screenOptions={{
    ...
    <Tab.Screen name="Promo" component={PromoScreen} options={{ tabBarIcon: ({ focused }) => <TabIcon name={focused ? 'pricetags' : 'pricetags-outline'} focused={focused} /> }} />
    ...
    <Tab.Screen name="Contact" component={ContactScreen} options={{ tabBarIcon: ({ focused }) => <TabIcon name={focused ? 'chatbubbles' : 'chatbubbles-outline'} focused={focused} /> }} />
  </Tab.Navigator>;
}

...
import { Badge, Card, Field, Label, Muted, PrimaryButton, SecondaryButton, Screen, SectionHeader, Subtitle, Title, screenContentStyle } from '../components/ui';
...
export default function MemberScreen() {
  ...
  function onSignOut() { Alert.alert('Sign out?', 'You will need to sign in with Gmail again to use MSpace.', [{ text: 'Cancel', style: 'cancel' }, { text: 'Sign out', style: 'destructive', onPress: () => { void signOut(); } }]); }
